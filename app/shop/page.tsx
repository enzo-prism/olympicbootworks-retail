...
export default function ShopPage() {
  ...
  useEffect(() => {
    ...
    window.onerror = function (message, source, lineno, colno, error) {
      ...
      if (message && (message.toString().includes("ResizeObserver") || message.toString().includes("querySelector"))) {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className={`shop-content ${isShopVisible ? "shop-visible" : "shop-hidden"}`}>
            ...
            <div className="shop-categories-wrapper mb-8 rounded-lg border p-4 bg-card">
              ...
              <div
                id="my-categories-115212795"
                ref={categoriesContainerRef}
                className="shop-categories-container"
              ></div>
            </div>
